...
#include "pages/AllUIElement.h"
#include "app/BankApp.h"
...
uint8_t NUM_UI_ELEMENTS = 8;  // number of UI elements
...
UIElement* UIController::allocateUIElement(ui_modes_t newMode) {
  ...
  switch(newMode) {
    ...
    case ui_paypal:
      m_element = new BankApp(u.tftp, u.tsp, u.sdp);            break;
    default:
...
const char *UIController::modeName(ui_modes_t m) {
  switch(m) {
    ...
    case ui_paypal:             return "ui_paypal";   break;
